      ...
      while (array.length > 0) {
        ...
        switch (command) {
          ...
          case APPLYHTML: {
            ...
            //const element = document.querySelector(selector); // TODO: usar querySelectorAll e tratar uma lista
            if (element) {
          ...
          default:
            console.error("Unknown command:", command, payloadLength, payload);
            break;
        }
